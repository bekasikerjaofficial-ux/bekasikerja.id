...
export default function UMKJawaTimur2026() {
  return (
    <>
      ...
      <div className="container" style={{ paddingTop: 12 }}><ArticleReaderCount slug="umk-jawa-timur-2026" /></div>
      ...
      <main id="main" className="section">
        <div className="container">
          ...
          <div style={{ textAlign: 'center', marginTop: 32, display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <p className="text-muted" style={{ marginTop: 12, fontSize: 13, width: '100%' }}>Pastikan upah tidak di bawah UMK Jatim.</p>
          </div>
        </div>
      </main>
      <LatestNewsLinks />
