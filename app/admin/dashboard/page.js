...
export default function AdminDashboard() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Di sini nantinya data disimpan ke Database (Supabase)
    ...
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      <header className="bg-blue-950 text-white px-6 py-4 flex justify-between items-center border-b border-blue-900">
        <div className="flex items-center gap-2">
          <span className="bg-yellow-500 text-blue-950 font-black px-2 py-0.5 rounded text-xs">ADMIN</span>
      ...
      <main className="max-w-3xl mx-auto p-6">
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-6">
          <div className="border-b pb-4">
            ...
            <p className="text-xs text-slate-500">Isi formulir di bawah ini untuk menampilkan loker baru di website.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-2.5 border rounded-lg focus:outline-none focus:border-blue-900"
              />
              <span className="text-[10px] text-slate-400 mt-1 block">*Masukkan URL gambar logo atau poster lowongan</span>
            </div>
            ...
            <div>
              ...
              <textarea
                name="description"
                rows="5"
                placeholder="Tuliskan kualifikasi, tugas pekerjaan, dan cara melamar..."
                onChange={handleChange}
                className="w-full p-2.5 border rounded-lg focus:outline-none focus:border-blue-900"
              ></textarea>
            </div>
