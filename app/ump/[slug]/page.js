...
export default function UmpProvincePage({ params }) {
  ...
  return <>
    ...
    <main id="main" className="section"><div className="container">
      ...
      <div style={{ textAlign: 'center', marginTop: '80px', marginBottom: '80px', display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
        <Link href="/ump-indonesia-2026" className="btn-secondary" style={{ fontSize: 14, textDecoration: 'none' }}>← Lihat daftar seluruh provinsi</Link>
